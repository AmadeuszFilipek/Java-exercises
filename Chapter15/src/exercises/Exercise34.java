...
public class Exercise34 extends Application {

	public void start(Stage primaryStage) {

		RandomWalkPane pane = new RandomWalkPane(16);

		BorderPane borderPane = new BorderPane();
		Button btnStart = new Button("Start");
		btnStart.setOnAction(e -> {pane.redraw();});

		borderPane.setCenter(pane);
		borderPane.setBottom(btnStart);
	...
	public static class RandomWalkPane extends Pane {
		...
		public void redraw() {
			...
			for(Point2D point : points)
				path.getPoints().addAll(point.getX() * cellWidth, point.getY() * cellHeight);
